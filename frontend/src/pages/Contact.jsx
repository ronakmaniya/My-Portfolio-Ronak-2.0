  ...
  return (
    <div className="flex flex-col gap-7 pb-4 pt-2">
      <header className="rounded-[24px] border border-edge bg-paper-strong p-8 shadow-soft max-[720px]:p-6">
        <p className="mb-2 text-[12px] uppercase tracking-[2px] text-accent-strong">Contact</p>
        <h1 className="text-[clamp(2.4rem,3.5vw,3.6rem)] leading-[1.15]">Lets build something meaningful together.</h1>
        <p className="text-[1.05rem] text-ink-soft max-w-[540px]">{contact.cta}</p>
      </header>
          ...
          <div className="card">
            ...
            <form className="mt-3 grid gap-3" onSubmit={handleSubmit}>
              <input
                ...
                required
                className="rounded-[12px] border border-edge bg-paper px-3 py-2 font-sans text-ink focus:border-accent focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)]/20"
              />
              <input
                name="email"
                type="email"
              ...
              {status.message ? (
                <p
                  className={`rounded-[10px] bg-paper-strong px-3 py-2 text-sm ${
