    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <span className="footer-subtitle">{title}</span>
        </div>
        <div className="footer-actions">
          {social.map((link) => (
            <a key={link.label} className="footer-link" href={link.url} target="_blank" rel="noreferrer">
              {iconMap[link.label]}
      ...
      <div className="footer-bottom">
        ...
        <span className="footer-copy">© {footerYear} {copyrightName}. All rights reserved.</span>
        <span className="footer-tech">{footer?.techNote}</span>
      </div>
    </footer>
  )
}
